...
public class Catalogo {
    protected static List<Disco> discos = new ArrayList<>(); //Cria e inicializa a lista de discos
    protected static List<Artista> artistas = new ArrayList<>(); //Cria e inicializa a lista de artistas
    ...
    public void removerDiscoOuArtista() {
        ...
        if (escolha.equals("disco")) {
            ...
            if (artistas.isEmpty()) {
                ...
                listarArtistas();
                System.out.println("Digite o nome do artista que deseja remover: ");
                String nomeArtista = scanner.nextLine();
                Artista artista = buscarArtista(nomeArtista);
